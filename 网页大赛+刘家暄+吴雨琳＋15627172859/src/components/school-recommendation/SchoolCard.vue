  ...
  >
    ...
    <div class="card-body">
      ...
      <div class="card-meta-row">
        ...
        <span class="meta-dot" />
        <span
          v-if="school?.topMajor"
          class="meta-txt"
        >{{ school.topMajor }}</span>
      </div>
      ...
      <div class="card-actions">
        <button
          class="c-action c-action--primary"
          @click="viewDetail"
        >
          <svg
            width="13"
